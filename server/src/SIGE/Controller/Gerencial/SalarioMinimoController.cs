...
namespace SIGE.Controller.Gerencial
{
    ...
    public class SalarioMinimoController(IBaseInterface<SalarioMinimoDto> service) : ControllerBase
    {
        private readonly IBaseInterface<SalarioMinimoDto> _service = service;
        ...
        public async Task<IActionResult> Incluir([FromBody] SalarioMinimoDto req) =>
        ...
        [ProducesResponseType(typeof(Response), 401)]
        [ProducesResponseType(typeof(Response), 500)]
        public async Task<IActionResult> Alterar([FromBody] SalarioMinimoDto req) =>
