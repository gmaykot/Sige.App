...
{
    [ApiController]
    [Route("valor-mensal-ponto-medicao")]
    public class ValorMensalPontoMedicaoController(IValorMensalPontoMedicaoService service) : ControllerBase
    {
        private readonly IValorMensalPontoMedicaoService _service = service;
        ...
        public async Task<IActionResult> Incluir([FromBody] ValorMensalPontoMedicaoDto req) =>
        ...
        [ProducesResponseType(typeof(Response), 401)]
        [ProducesResponseType(typeof(Response), 500)]
        public async Task<IActionResult> Alterar([FromBody] ValorMensalPontoMedicaoDto req) =>
