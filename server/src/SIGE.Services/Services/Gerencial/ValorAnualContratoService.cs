...
{
    public class ValorAnualContratoService(AppDbContext appDbContext, IMapper mapper) : BaseService<ValorAnualContratoDto, ValorAnualContratoModel>(appDbContext, mapper)
    {
