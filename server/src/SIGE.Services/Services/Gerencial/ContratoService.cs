...
namespace SIGE.Services.Services.Gerencial {
    public class ContratoService(AppDbContext appDbContext, IMapper mapper, IAppLogger appLogger) : BaseService<ContratoDto, ContratoModel>(appDbContext, mapper, appLogger), IContratoService {
