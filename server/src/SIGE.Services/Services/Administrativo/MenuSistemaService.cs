...
namespace SIGE.Services.Services.Administrativo {
    public class MenuSistemaService(AppDbContext appDbContext, IMapper mapper, IAppLogger appLogger) : BaseService<MenuSistemaDto, MenuSistemaModel>(appDbContext, mapper, appLogger), IMenuSistemaService {
