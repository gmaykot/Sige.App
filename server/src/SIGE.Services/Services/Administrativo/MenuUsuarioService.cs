...
namespace SIGE.Services.Services.Administrativo {
    public class MenuUsuarioService(AppDbContext appDbContext, IMapper mapper, ICacheManager cacheManager, IOptions<CacheOption> cacheOption, IAppLogger appLogger) : BaseService<MenuUsuarioDto, MenuUsuarioModel>(appDbContext, mapper, appLogger), IMenuUsuarioService {
