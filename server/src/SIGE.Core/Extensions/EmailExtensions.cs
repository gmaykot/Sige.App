namespace SIGE.Core.Extensions {
    public static class EmailExtensions {
        ...
        public static string GetEmailTemplateEconomia(string recipientName, string month, string phoneNumber, string emailAddress, string empresa, string pixelUrl, string urlBase) {
            string template = @"
                <!DOCTYPE html>
                <html lang=""pt-BR"">
                <head>
                  <meta charset=""UTF-8"">
                  <meta name=""viewport"" content=""width=device-width, initial-scale=1.0"">
                  <title>Relatório de Economia - {1} - {4}</title>
                  <style>
                    /* Estilos gerais */
                    body {{
                      font-family: Arial, sans-serif;
