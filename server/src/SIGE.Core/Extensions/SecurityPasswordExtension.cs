...
namespace SIGE.Core.Extensions {
    ...
    public static class SecurityPasswordExtension {
        ...
        public static string GetMenuJWT(
            this IEnumerable<MenuSistemaDto> menusUsuario,
            ...
            List<Claim> claims =
                new()
                {
                    new Claim(
                        "menus",
                        JsonConvert.SerializeObject(menusUsuario).Replace("Title", "title")
                    )
                };
        ...
        public static string GetTokenJWT(this UsuarioModel usuario, string? securityToken) {
            List<Claim> claims =
                new()
                {
                    ...
                    new Claim("su", usuario.SysAdm.ToString())
                };
